...
// Creating an object using function and passing values via constructor
...
// Creating an object using class and passing values using constructor method
class obj3 {
  constructor(name3, age3) {
    (this.name3 = name3), (this.age3 = age3);
  }
  greet = () => {
